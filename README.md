# Arufa — Be a Microsoft FDE for a Day

<p align="center"><em>Signal triaging, extraction, and orchestration — one API scored by FDEBench.</em></p>

> **About this fork.** `arorashivam96/Arufa` is the working repo for our FDEBench
> submission. It tracks `microsoft/be-an-fde-for-a-day` as `upstream`; our
> service code lives under [`py/apps/arufa/`](py/apps/arufa/) and our submission
> docs at [`docs/architecture.md`](docs/architecture.md),
> [`docs/methodology.md`](docs/methodology.md), and
> [`docs/evals.md`](docs/evals.md). Pull upstream updates with
...
When you're ready, see [docs/submission/](docs/submission/) for the submission checklist and submit at [aka.ms/delta/fdebench/hackathon](https://aka.ms/delta/fdebench/hackathon).

> **Questions?** Check the [FDEBench FAQ](https://aka.ms/delta/fdebench/faq) first. It answers the most common ones, including which repository to use (this one, `microsoft/be-an-fde-for-a-day`), forking, deployment, and scoring.
...
See [docs/submission/](docs/submission/) for the full checklist, then submit at [aka.ms/delta/fdebench/hackathon](https://aka.ms/delta/fdebench/hackathon).
