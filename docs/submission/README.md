...
1. **Fork** this repo (your fork must be **private** — this repository contains Microsoft-owned material that is **not** authorized for public distribution)
...
6. **Push** everything to your private fork, then grant the judges read access (see below)
7. **Submit** at **[aka.ms/delta/fdebench/hackathon](https://aka.ms/delta/fdebench/hackathon)**

> **Keep your fork private.** This repo contains Microsoft-owned internal
> material and must not be redistributed publicly. Create your fork as a
> **private** repository and share access with the judges rather than
> making it public.
...
- [ ] Submitted at **[aka.ms/delta/fdebench/hackathon](https://aka.ms/delta/fdebench/hackathon)**
