...
For the most common questions, including which repository to use
(this one, `microsoft/be-an-fde-for-a-day`), forking, deployment, and
scoring, check the [FDEBench FAQ](https://aka.ms/delta/fdebench/faq)
first.
